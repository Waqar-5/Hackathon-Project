      ...
      <section>
        <div className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
            {['chair', 'Vase', 'Silky', 'Lamping'].map((item, idx) => (
          ...
          <div className="flex flex-col md:flex-row gap-6 mt-12 text-sm md:text-base">
            {features.map((feature, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col md:w-1/4 p-4 rounded-lg transition-transform duration-200 hover:scale-105 hover:cursor-pointer bg-[#FAFAFA]">
                  <Icon size={30} className="text-[#2A254B] transition-transform duration-200 hover:scale-105 hover:cursor-pointer " />
